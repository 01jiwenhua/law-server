...
<p class="MsoNormal"><span style="font-family:宋体; ">本协议约定北京市安全生产监督管理局与用户之间关于“北京市危化监管综合查询系统”服务（以下简称“服务”）的权利义务。“用户”是指注册、登录、使用本服务的个人。本协议可由北京市安全生产监督管理局随时更新，更新后的协议条款一旦公布即代替原来的协议条款，恕不再另行通知，用户可在本APP中查阅最新版协议条款。在修改协议条款后，如果用户不接受修改后的条款，请立即停止使用北京市安全生产监督管理局提供的服务，用户继续使用北京市安全生产监督管理局提供的服务将被视为接受修改后的协议。</span>&nbsp;</p>
