...
<h2><span style="font-family:宋体; ">一、特别提示</span>&nbsp;</h2>
<p class="MsoNormal"><span style="font-family:宋体; ">欢迎使用北京市危化法规标准查询系统服务（以下简称“服务”）！</span> </p>
<p class="MsoNormal"><span style="font-family:宋体; ">在此特别提醒您（用户）在注册成为北京市危化法规标准查询系统用户之前，请认真阅读本《北京市危化法规标准查询系统用户服务协议》（以下简称“协议”），确保您充分理解本协议中各条款。请您审慎阅读并选择接受或不接受本协议。除非您接受本协议所有条款，否则您无权注册、登录或使用本协议所涉服务。您的注册、登录、使用等行为将视为对本协议的接受，并同意接受本协议各项条款的约束。</span>&nbsp;</p>
<p class="MsoNormal"><span style="font-family:宋体; ">本协议约定北京市安全生产监督管理局与用户之间关于“北京市危化法规标准查询系统”服务（以下简称“服务”）的权利义务。“用户”是指注册、登录、使用本服务的个人。本协议可由北京市安全生产监督管理局随时更新，更新后的协议条款一旦公布即代替原来的协议条款，恕不再另行通知，用户可在本APP中查阅最新版协议条款。在修改协议条款后，如果用户不接受修改后的条款，请立即停止使用北京市安全生产监督管理局提供的服务，用户继续使用北京市安全生产监督管理局提供的服务将被视为接受修改后的协议。</span>&nbsp;</p>
<h2><span style="font-family:宋体; ">二、账号注册</span>&nbsp;</h2>
<p class="MsoNormal">1<span style="font-family:宋体; ">、用户在使用本服务前需要注册一个“北京市危化法规标准查询系统”账号。“北京市危化法规标准查询系统”账号应当使用手机号码绑定注册，请用户使用尚未与“北京市危化法规标准查询系统”账号绑定的手机号码，以及未被北京市安全生产监督管理局根据本协议封禁的手机号码注册“北京市危化法规标准查询系统”账号。北京市安全生产监督管理局可以根据用户需求或产品需要对账号注册和绑定的方式进行变更，而无须事先通知用户。</span>&nbsp;</p>
...
<p class="MsoNormal">3<span style="font-family:宋体; ">、鉴于“北京市危化法规标准查询系统”账号的绑定注册方式，您同意北京市安全生产监督管理局在注册时将允许您的手机号码及手机设备识别码等信息用于注册。</span>&nbsp;</p>
...
<p class="MsoNormal">1<span style="font-family:宋体; ">、用户一旦注册成功，成为北京市危化法规标准查询系统的用户，将得到一个可通过动态短信验证码登录的账号，并有权利使用自己的账号随时登陆北京市危化法规标准查询系统；</span> </p>
<p class="MsoNormal">2<span style="font-family:宋体; ">、用户对账号的安全负全部责任，同时对以其账号进行的所有活动和事件负全责。</span>&nbsp;</p>
<p class="MsoNormal">3<span style="font-family:宋体; ">、用户不得以任何形式擅自转让或授权他人使用自己的北京市危化法规标准查询系统账号。</span>&nbsp;</p>
<p class="MsoNormal">4<span style="font-family:宋体; ">、如果用户泄漏了密码，有可能导致不利的法律后果，因此不管任何原因导致用户的密码安全受到威胁，应该立即和北京市危化法规标准查询系统客服人员取得联系，否则后果自负。</span>&nbsp;</p>
...
<p class="MsoNormal">2<span style="font-family:宋体; ">、用户有义务在注册时提供自己的真实资料，并保证诸如手机号码、姓名、所在地区等内容的有效性及安全性，保证北京市危化法规标准查询系统客服人员可以通过上述联系方式与用户取得联系。同时，用户也有义务在相关资料实际变更时及时更新有关注册资料。</span>&nbsp;</p>
<p class="MsoNormal">3<span style="font-family:宋体; ">、用户通过使用北京市危化法规标准查询系统的过程中所制作、上载、复制、发布、传播的任何内容，包括但不限于账号头像、名称、用户说明等注册信息及认证资料，或文字、语音、图片、视频、图文等发送、回复和相关链接页面，以及其他使用账号或本服务所产生的内容，不得违反国家相关法律制度，包含但不限于如下原则：</span> </p>
...
<p class="MsoNormal">4<span style="font-family:宋体; ">、用户不得利用“北京市危化法规标准查询系统”账号或本服务制作、上载、复制、发布、传播下干扰“北京市危化法规标准查询系统”正常运营，以及侵犯其他用户或第三方合法权益的内容：</span> </p>
...
<p class="MsoNormal">1<span style="font-family:宋体; ">、北京市危化法规标准查询系统具体服务内容由北京市安全生产监督管理局根据实际情况提供，包括但不限于：</span> </p>
...
<p class="MsoNormal">1)&nbsp;<span style="font-family:宋体; ">在用户违反本服务协议相关规定时，北京市危化法规标准查询系统有权终止向该用户提供服务。如该用户再一次直接或间接或以他人名义注册为用户的，一经发现，北京市危化法规标准查询系统有权直接单方面终止向该用户提供服务；</span>&nbsp;</p>
<p class="MsoNormal">2)&nbsp;<span style="font-family:宋体; ">如北京市危化法规标准查询系统通过用户提供的信息与用户联系时，发现用户在注册时填写的联系方式已不存在或无法接通，北京市危化法规标准查询系统以其它联系方式通知用户更改，而用户在三个工作日内仍未能提供新的联系方式，北京市危化法规标准查询系统有权终止向该用户提供服务；</span>&nbsp;</p>
<p class="MsoNormal">3)&nbsp;<span style="font-family:宋体; ">一旦北京市危化法规标准查询系统发现用户提供的数据或信息中含有虚假内容，北京市危化法规标准查询系统有权随时终止向该用户提供服务；</span>&nbsp;</p>
<p class="MsoNormal">4)&nbsp;<span style="font-family:宋体; ">本服务条款终止或更新时，用户明示不愿接受新的服务条款；</span> </p>
<p class="MsoNormal">5)&nbsp;<span style="font-family:宋体; ">其它北京市危化法规标准查询系统认为需终止服务的情况。</span>&nbsp;</p>
<p class="MsoNormal">2<span style="font-family:宋体; ">、服务终止后，北京市危化法规标准查询系统没有义务为用户保留原账号中或与之相关的任何信息，或转发任何未曾阅读或发送的信息给用户或第三方。</span> </p>
<h2><span style="font-family:宋体; ">七、服务的变更、中断</span> </h2>
<p class="MsoNormal">1<span style="font-family:宋体; ">、鉴于网络服务的特殊性，用户需同意北京市危化法规标准查询系统会变更、中断部分或全部的网络服务，并删除（不再保存）用户在使用过程中提交的任何资料，而无需通知用户，也无需对任何用户或任何第三方承担任何责任。</span>&nbsp;</p>
<p class="MsoNormal">&nbsp;</p>
<p class="MsoNormal">2<span style="font-family:宋体; ">、北京市危化法规标准查询系统需要定期或不定期地对提供网络服务的平台进行检测或者更新，如因此类情况而造成网络服务在合理时间内的中断，北京市危化法规标准查询系统无需为此承担任何责任。</span> </p>
<h2><span style="font-family:宋体; ">八、服务条款修改</span>&nbsp;</h2>
<p class="MsoNormal">1<span style="font-family:宋体; ">、北京市危化法规标准查询系统有权随时修改本服务条款的任何内容，一旦本服务条款的任何内容发生变动，北京市危化法规标准查询系统将会通过适当方式向用户提示修改内容。</span>&nbsp;</p>
<p class="MsoNormal">2<span style="font-family:宋体; ">、如果不同意北京市危化法规标准查询系统对本服务条款所做的修改，用户有权停止使用网络服务。</span> </p>
<p class="MsoNormal">3<span style="font-family:宋体; ">、如果用户继续使用网络服务，则视为用户接受北京市危化法规标准查询系统对本服务条款所做的修改。</span>&nbsp;</p>
<h2><span style="font-family:宋体; ">九、免责与赔偿声明</span>&nbsp;</h2>
<p class="MsoNormal">1<span style="font-family:宋体; ">、若北京市危化法规标准查询系统已经明示其服务提供方式发生变更并提醒用户应当注意事项，用户未按要求操作所产生的一切后果由用户自行承担。</span>&nbsp;</p>
<p class="MsoNormal">2<span style="font-family:宋体; ">、用户明确同意其使用北京市危化法规标准查询系统所存在的风险将完全由其自己承担，因其使用北京市危化法规标准查询系统而产生的一切后果也由其自己承担。</span>&nbsp;</p>
<p class="MsoNormal">3<span style="font-family:宋体; ">、用户同意保障和维护北京市危化法规标准查询系统及其他用户的利益，由于用户在使用北京市危化法规标准查询系统有违法、不真实、不正当、侵犯第三方合法权益的行为，或用户违反本协议项下的任何条款而给北京市危化法规标准查询系统及任何其他第三方造成损失，用户同意承担由此造成的损害赔偿责任。</span>&nbsp;</p>
<h2><span style="font-family:宋体; ">十、隐私声明</span>&nbsp;</h2>
<p class="MsoNormal">1<span style="font-family:宋体; ">、适用范围：</span>&nbsp;</p>
<p class="MsoNormal">1)&nbsp;<span style="font-family:宋体; ">在用户注册北京市危化法规标准查询系统账户时，根据要求提供的个人注册信息；</span>&nbsp;</p>
<p class="MsoNormal">2)&nbsp;<span style="font-family:宋体; ">在用户使用北京市危化法规标准查询系统，或访问其相关页面时，北京市危化法规标准查询系统自动接收并记录用户的操作行为和查询记录等用户要求取用的数据记录。</span>&nbsp;</p>
<p class="MsoNormal">2<span style="font-family:宋体; ">、信息使用：</span>&nbsp;</p>
<p class="MsoNormal">1)&nbsp;<span style="font-family:宋体; ">北京市危化法规标准查询系统不会向任何人出售或出借用户的个人信息，除非事先得到用户的许可</span> </p>
<p class="MsoNormal">2)&nbsp;<span style="font-family:宋体; ">北京市危化法规标准查询系统亦不允许任何第三方以任何手段收集、编辑、出售或者无偿传播用户的个人信息。任何用户如从事上述活动，一经发现，北京市危化法规标准查询系统有权立即终止与该用户的服务协议，查封其账号。</span>&nbsp;</p>
<p class="MsoNormal">3)&nbsp;<span style="font-family:宋体; ">为达到服务用户的目的，北京市危化法规标准查询系统可能通过使用用户的个人信息，向用户提供服务，包括但不限于向用户发出产品和服务信息，或者与北京市危化法规标准查询系统合作伙伴共享信息以便他们向用户发送有关其产品和服务的信息。</span> </p>
...
<p class="MsoNormal">5)&nbsp;<span style="font-family:宋体; ">其它北京市危化法规标准查询系统根据法律或者网站政策认为合适的披露；</span> </p>
<p class="MsoNormal">6)&nbsp;<span style="font-family:宋体; ">用户使用北京市危化法规标准查询系统时提供的银行账户信息，北京市危化法规标准查询系统将严格履行相关保密约定。</span> </p>
...
<p class="MsoNormal">1<span style="font-family:宋体; ">、北京市危化法规标准查询系统郑重提醒用户注意本协议中免除北京市安全生产监督管理局责任和限制用户权利的条款，请用户仔细阅读，自主考虑风险。未成年人应在法定监护人的陪同下阅读本协议。</span>&nbsp;</p>
